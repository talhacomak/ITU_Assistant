...
public class frSalijava extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.sali, container, false);
        ...
        if(getArguments() != null){
            ...
            share.remove(getActivity(), "Sali");
            share.remove(getActivity(), "Sali_Saat");
            share.save(getActivity(), "days", days_ar);
            share.save(getActivity(), "Sali", mySet);
            share.save(getActivity(), "Sali_Saat", mySet2);

        }
        else{
            shared_pref sharenew = new shared_pref();
            days_ar = sharenew.getStringArray(getActivity(),"days");
            Set<String> dersAdiSet = sharenew.getStringSet(getActivity(), "Sali");
            Set<String> dersSaatiSet = sharenew.getStringSet(getActivity(), "Sali"+"_Saat");
        ...
        for(int i=0; i<strArray.length; i++){
            if(strArray[i] == null || !days_ar[i].equals("Sali")) continue;
